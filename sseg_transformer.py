...
NUM_EPOCHS = 200
TRAIN = True
CHECKPOINT_PATH = './models/checkpoints/transformer_chkpt_new2.pth'
VISUAL_OUTPUT_DIR = 'transformer_vis_400'
NUM_CLASSES = 4
NUM_LAYERS = 8
NUM_HEADS = 12
...
class SidewalkSegmentationModel(nn.Module):
    def __init__(self, hidden_dim=768, num_layers=NUM_LAYERS, nhead=NUM_HEADS,
        ...
        enc_layer = nn.TransformerEncoderLayer(
            ...
            dropout=ff_drop, activation='gelu', batch_first=False
        )
...
if __name__ == '__main__':
    ...
    train_root = './data/data_split_manhat/train'
    test_root  = './data/data_split_manhat/test'
